...
public class AccessKeyDelegationTokenAuthenticationHandler
    extends DelegationTokenAuthenticationHandler {

  public AccessKeyDelegationTokenAuthenticationHandler() {
    super(new AccessKeyAuthenticationHandler());
  }
